...
const RoomDetails = (props: { params: { slug: string } }) => {
    ...
    const handleBookNowClick = async () => {
        if (!checkinDate || !checkoutDate) return toast.error("please provide cheackin / cheackout date")

        if (checkinDate > checkoutDate) return toast.error("Please choose  a valid checkIn")
